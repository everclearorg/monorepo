...
# ============================================================================
# LIGHTHOUSE HANDLER - TEMPORARILY DISABLED
# ============================================================================
# Disabled while lighthouse queue Redis connectivity issue is being resolved.
# Using lighthouse poller lambdas above instead.
# ============================================================================
...
module "ecs" {
  ...
  environment             = var.environment
  domain                  = var.domain
  ecs_cluster_name_prefix = "everclear-ecs"
}
