...
variable "enable_transaction_logs_disk_usage_alarm" {
  description = "Enable alarm for transaction logs disk usage"
  type        = bool
}

variable "transaction_logs_disk_usage_threshold" {
  type        = number
  description = "The transaction logs disk usage threshold"
  default     = 650000000000  // 650GB > MAX WAL SIZE
  }
