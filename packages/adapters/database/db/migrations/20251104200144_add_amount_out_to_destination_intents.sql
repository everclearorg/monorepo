...
ALTER TABLE public.destination_intents ADD COLUMN amount_out character varying(255);
...
ALTER TABLE public.destination_intents DROP COLUMN IF EXISTS amount_out;
