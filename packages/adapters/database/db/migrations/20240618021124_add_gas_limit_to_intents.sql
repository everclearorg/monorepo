-- migrate:up
ALTER TABLE origin_intents ADD COLUMN gas_limit bigint NOT NULL;
ALTER TABLE origin_intents ADD COLUMN gas_price bigint NOT NULL;
ALTER TABLE destination_intents ADD COLUMN gas_limit bigint NOT NULL;
ALTER TABLE destination_intents ADD COLUMN gas_price bigint NOT NULL;
...
FROM origin_intents
JOIN destination_intents
ON origin_intents.id = destination_intents.id
JOIN hub_intents
ON origin_intents.id = hub_intents.id;;

-- migrate:down
ALTER TABLE origin_intents DROP COLUMN gas_limit;
ALTER TABLE origin_intents DROP COLUMN gas_price;
ALTER TABLE destination_intents DROP COLUMN gas_limit;
ALTER TABLE destination_intents DROP COLUMN gas_price;