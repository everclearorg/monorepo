-- migrate:up
ALTER TABLE hub_intents ADD COLUMN settlement_epoch bigint;

DROP MATERIALIZED VIEW intents;
DROP MATERIALIZED VIEW invoices;
...
GRANT SELECT ON public.hub_deposits TO query;
GRANT SELECT ON public.hub_deposits TO reader;
GRANT SELECT ON public.hub_invoices TO query;
GRANT SELECT ON public.hub_invoices TO reader;
...
ALTER TABLE hub_intents DROP COLUMN settlement_epoch bigint;
