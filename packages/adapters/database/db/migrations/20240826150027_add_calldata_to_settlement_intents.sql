-- migrate:up
ALTER TABLE settlement_intents ADD COLUMN IF NOT EXISTS return_data VARCHAR;
ALTER TABLE settlement_intents ADD COLUMN IF NOT EXISTS status public.intent_status DEFAULT 'SETTLED'::public.intent_status NOT NULL;
...
ALTER TABLE settlement_intents DROP COLUMN return_data;
ALTER TABLE settlement_intents DROP COLUMN status;
