...
ALTER TABLE public.origin_intents ADD COLUMN amount_out_min character varying(255);
ALTER TABLE public.destination_intents ADD COLUMN amount_out_min character varying(255);
...
CREATE TABLE public.swap_intents (
    ...
    swap_pair_id VARCHAR(50) NOT NULL,
    origin_chain VARCHAR(20) NOT NULL,
    destination_chain VARCHAR(20) NOT NULL,
    input_amount VARCHAR(78) NOT NULL,
    expected_output_amount VARCHAR(78) NOT NULL,
    actual_output_amount VARCHAR(78),
    margin_bps INTEGER NOT NULL,
    swap_rate VARCHAR(78) NOT NULL,
    swap_identifier VARCHAR(66) NOT NULL,
    micky_address VARCHAR(66) NOT NULL,
    user_address VARCHAR(66) NOT NULL,
    status VARCHAR(20) NOT NULL,
    fill_method VARCHAR(20),
...
CREATE TABLE public.swap_fills (
    ...
    fill_tx_hash VARCHAR(66) NOT NULL,
    distribution_tx_hash VARCHAR(66),
    fill_method VARCHAR(20) NOT NULL,
    filled_at BIGINT NOT NULL,
    distributed_at BIGINT,
    gas_used VARCHAR(78),
    CONSTRAINT swap_fills_intent_id_fkey FOREIGN KEY (intent_id)
        REFERENCES public.swap_intents (intent_id)
);
...
CREATE TABLE public.swap_inventory_snapshots (
    ...
    total_inventory VARCHAR(78) NOT NULL,
    reserved_inventory VARCHAR(78) NOT NULL,
    available_inventory VARCHAR(78) NOT NULL,
...
ALTER TABLE public.destination_intents DROP COLUMN IF EXISTS amount_out_min;
ALTER TABLE public.origin_intents DROP COLUMN IF EXISTS amount_out_min;

DROP TABLE IF EXISTS public.swap_inventory_snapshots;
DROP TABLE IF EXISTS public.swap_fills;
DROP TABLE IF EXISTS public.swap_intents;