...
ALTER TABLE hub_intents RENAME COLUMN enqueued_tx_nonce TO settlement_enqueued_tx_nonce;
ALTER TABLE hub_intents RENAME COLUMN enqueued_timestamp TO settlement_enqueued_timestamp;

ALTER TABLE hub_intents ADD COLUMN settlement_enqueued_block_number bigint;
ALTER TABLE hub_intents ADD COLUMN settlement_amount bigint;
...
ALTER TABLE hub_intents RENAME COLUMN settlement_enqueued_tx_nonce TO enqueued_tx_nonce;
ALTER TABLE hub_intents RENAME COLUMN settlement_enqueued_timestamp TO enqueued_timestamp;

ALTER TABLE hub_intents DROP COLUMN settlement_enqueued_block_number;
ALTER TABLE hub_intents DROP COLUMN settlement_amount;
