...
ALTER TABLE hub_intents ADD COLUMN update_virtual_balance boolean;
ALTER TABLE settlement_intents DROP COLUMN update_virtual_balances;
...
ALTER TABLE hub_intents DROP COLUMN update_virtual_balance;
ALTER TABLE settlement_intents ADD COLUMN update_virtual_balances boolean NOT NULL DEFAULT TRUE;
