...
export class OnchainTransaction {
  ...
  public responses: ITransactionResponse[] = [];

  // Receipt that we received for the on-chain transaction that was mined with
  // the desired number of confirmations.
  private _receipt: ITransactionReceipt | undefined;
  public get receipt(): ITransactionReceipt | undefined {
    return this._receipt;
  }
  public set receipt(value: ITransactionReceipt | undefined) {
   ...
   */
  public get params(): ITransactionRequest {
    return {
      to: this.minTx.to,
      data: this.minTx.data,
      value: this.minTx.value,
      nonce: this.nonce,
      type: this.type,
