...
describe('mqclient', () => {
  ...
  describe('pingRedis', () => {
    it('should return true when Redis responds with PONG', async () => {
      const mockClient = { ping: stub().resolves('PONG') };
    ...
    it('should return false when Redis does not respond with PONG', async () => {
      const mockClient = { ping: stub().resolves('NOT_PONG') };
      const mockQueue = { client: Promise.resolve(mockClient) } as unknown as Queue;
    ...
    it('should return false when ping throws an error', async () => {
      const mockClient = { ping: stub().rejects(new Error('connection refused')) };
      const mockQueue = { client: Promise.resolve(mockClient) } as unknown as Queue;
  ...
  describe('createProducer', () => {
    ...
    it('should return a Queue instance', () => {
      const queue = createProducer('redis://localhost:6379', 'test-queue', mockLogger);
  ...
  describe('createWorker', () => {
    ...
    it('should return a Worker instance', () => {
      ...
      const worker = createWorker('redis://localhost:6379', 'test-queue', processor, mockLogger);
