...
use crate::instructions::EVMEncode;
...
mod tests {
    ...
    fn test_compute_intent_hash() {
        ...
        let intent = EVMIntent {
            initiator: <[u8; 32]>::from_hex(
                "00000000000000000000000065588b1121eb7dd41ba7d82a4f387548381584a9",
            )
            .unwrap(),
            receiver: <[u8; 32]>::from_hex(
                "00000000000000000000000039096a17ba70fe5c1eddb923f940b2e6deae5c3b",
            )
            .unwrap(),
            input_asset: <[u8; 32]>::from_hex(
                "000000000000000000000000833589fcd6edb6e08f4c7c32d4f71b54bda02913",
            )
            .unwrap(),
            output_asset: <[u8; 32]>::from_hex(
                "00000000000000000000000094b008aa00579c1307b0ef2c499ad98a8ce58e58",
            )
            .unwrap(),
            origin: 8453,
            nonce: 168,
