// Global //
export const POLYMER_PROD_MAILBOX: string = 'TJHSpk2YGfNWuFyDpsbjCY33o8FtDeMapv';
export const POLYMER_PROD_ISM: string = 'TVxZzZEK9dKj1Y5ZK4HhEFZPWGQEwDuz47';
...
// Production //
export const SPOKE_PROD: string = 'TQ7ZmvN6K2TaSpzbz8KUw8bSK2zsSeksxJ';
export const EVERCLEAR_SPOKE_GATEWAY_PROD = 'TP5oAAfdfNbAF8VMhTfCw3uQjpQii5pZWH';
...
export const EVERCLEAR_SPOKE_GATEWAY_STAGING = 'TCqgpCHXGiVbPnEafTK6JGaNjaZFAG3m7Y';
