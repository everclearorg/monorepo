...
interface IEverclearSpokeV5 is ISpokeStorageV5 {
   ...
   */
  function processIntentQueue(Intent[] calldata _intents, uint256 _dynamicGasLimit) external payable;
   ...
   */
  function processFillQueue(uint32 _amount, uint256 _dynamicGasLimit) external payable;
