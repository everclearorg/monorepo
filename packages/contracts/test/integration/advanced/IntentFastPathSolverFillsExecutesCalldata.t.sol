...
contract FillIntent_ExecuteCalldata_Integration is IntegrationBase {
  ...
  function test_FillIntentAndExecuteCalldata() public {
    ...
    assertEq(oUSDT.balanceOf(_solver2), 0);
    assertEq(sepoliaEverclearSpoke.balances(address(oUSDT).toBytes32(), _solver2.toBytes32()), _amountAfterFees);
  }
}
