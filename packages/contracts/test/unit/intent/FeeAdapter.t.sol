...
contract Unit_UpdateFeeSigner is BaseTest {
  function test_Revert_UpdateFeeSigner_NotOwner(address _newSigner) public {
  ...
  function test_UpdateFeeSigner(address _newSigner) public {
    vm.expectEmit();
...
contract Unit_NewOrderSplitEvenly is BaseTest {
  ...
  function test_NewOrderSplitEvenly_FeeInTransacting(
    ...
    // Sending the order
    vm.prank(USER);
    (bytes32 _orderId, bytes32[] memory _intentIds) = adapter.newOrderSplitEvenly(
      _numOfIntents,
      _fee,
      _deadline,
      _sig,
  ...
  function test_NewOrderSplitEvenly_FeeInEth(
    ...
    // Sending the order
    vm.prank(USER);
    (bytes32 _orderId, bytes32[] memory _intentIds) = adapter.newOrderSplitEvenly{ value: _fee }(
      _numOfIntents,
      0,
      _deadline,
      _sig,
  ...
  function test_NewOrderSplitEvenly_FeeInTransactingAndEth(
    ...
    // Sending the order
    vm.prank(USER);
    (bytes32 _orderId, bytes32[] memory _intentIds) = adapter.newOrderSplitEvenly{ value: _ethFee }(
      _numOfIntents,
      _fee,
      _deadline,
      _sig,
...
contract Unit_NewOrder is BaseTest {
  ...
  function test_NewOrder_FeeWithTransactingAndEth(
    ...
    // Sending the order
    vm.prank(USER);
    (bytes32 _orderId, bytes32[] memory _intentIds) = adapter.newOrder{ value: _ethFee }(
      _fee,
      _deadline,
      _sig,
      _params
