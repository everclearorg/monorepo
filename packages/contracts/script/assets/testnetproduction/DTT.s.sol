...
contract DTT is AddAssetBase, TestnetProductionEnvironment {
    ...
    returns (string memory _symbol, IHubStorage.TokenSetup memory _setup)
  {
    ...
    _assetConfigs[0] = IHubStorage.AssetConfig({
      ...
      adopted: SEPOLIA_DECIMALS_TEST_TOKEN.toBytes32(),
    ...
    _assetConfigs[1] = IHubStorage.AssetConfig({
      tickerHash: _tickerHash,
      adopted: BSC_DECIMALS_TEST_TOKEN.toBytes32(),
      domain: BSC_TESTNET,
      approval: true,
      strategy: IEverclear.Strategy.DEFAULT
    });
    ...
    _assetConfigs[2] = IHubStorage.AssetConfig({
      tickerHash: _tickerHash,
      adopted: ARB_SEPOLIA_DECIMALS_TEST_TOKEN.toBytes32(),
      domain: ARB_SEPOLIA,
      approval: true,
      strategy: IEverclear.Strategy.DEFAULT
    });
    ...
    _assetConfigs[3] = IHubStorage.AssetConfig({
      tickerHash: _tickerHash,
      adopted: OP_SEPOLIA_DECIMALS_TEST_TOKEN.toBytes32(),
      domain: OP_SEPOLIA,
      approval: true,
      strategy: IEverclear.Strategy.DEFAULT
    });
