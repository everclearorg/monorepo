...
/**
 * @title IAssetManagerV2
 * @notice Interface for the AssetManager contract
 */
interface IAssetManagerV2 {
  /*//////////////////////////////////////////////////////////////
                                STRUCTS
    //////////////////////////////////////////////////////////////*/
   ...
   */
  event AssetConfigSet(IHubStorageV2.AssetConfig _config);

  /**
   * @notice Emitted when the token configurations are set
   * @param _configs The token configurations
   */
  event TokenConfigsSet(IHubStorageV2.TokenSetup[] _configs);
   ...
   */
  event PrioritizedStrategySet(bytes32 _tickerHash, IEverclearV2.Strategy _strategy);
  ...
  function setAdoptedForAsset(
    IHubStorageV2.AssetConfig calldata _config
  ) external;
  ...
  function setTokenConfigs(
    IHubStorageV2.TokenSetup[] calldata _configs
  ) external;
   ...
   * @param _strategy The strategy to be prioritized for the asset
   */
  function setPrioritizedStrategy(bytes32 _tickerHash, IEverclearV2.Strategy _strategy) external;
