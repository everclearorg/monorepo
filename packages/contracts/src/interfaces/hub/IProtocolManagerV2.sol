...
interface IProtocolManagerV2 {
   ...
   */
  event RoleAssigned(address indexed _account, IHubStorageV2.Role _role);
   ...
   */
  event SupportedDomainsAdded(IHubStorageV2.DomainSetup[] _domains);
   ...
   */
  event GasConfigUpdated(IHubStorageV2.GasConfig _oldGasConfig, IHubStorageV2.GasConfig _newGasConfig);
  /**
  ...
  function addSupportedDomains(
    IHubStorageV2.DomainSetup[] calldata _domains
  ) external;
