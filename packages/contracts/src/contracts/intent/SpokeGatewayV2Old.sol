...
//    */
//   /// @notice The Polymer mailbox identifier
//   /// @dev Polymer does not have a mailbox address, so we use address(0x1) as a sentinel value
//   // address public constant POLYMER_MAILBOX = address(0x1);

//   address public hyperlaneMailbox;
//   address public ccipMailbox;
//   IPolymer public polymerProver;
//   // TODO: Confirm removal of: uint256 private _nonce;

//   mapping(uint256 => uint256) public ecToCCIPChainId;
//   mapping(uint256 => uint256) public ccipToECId;
//   // TODO: Confirm removal of: mapping(bytes32 => bool) public usedProofHashes;
