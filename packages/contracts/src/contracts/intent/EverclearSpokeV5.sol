  ...
  IMessageReceiver
{
  ...
  /// @inheritdoc IEverclearSpokeV5
  function processIntentQueue(Intent[] calldata _intents, uint256 _dynamicGasLimit) external payable whenNotPaused {
  ...
  /// @inheritdoc IEverclearSpokeV5
  function processFillQueue(uint32 _amount, uint256 _dynamicGasLimit) external payable whenNotPaused {
    _checkDynamicGasLimit(_dynamicGasLimit);
