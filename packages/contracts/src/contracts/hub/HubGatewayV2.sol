...
contract HubGatewayV2 is GatewayV2, UUPSUpgradeable, IHubGatewayV2 {
  ...
  /// @inheritdoc IHubGatewayV2
  function initialize(IMailbox[] memory _mailboxes, uint32[] memory _chainIds) external reinitializer(2) onlyOwner {
   ...
   */
  function _checkValidSender(uint32 _origin, bytes32 _sender) internal view override(GatewayV2) {
