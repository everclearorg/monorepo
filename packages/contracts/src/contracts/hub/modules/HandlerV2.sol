 ...
 */
contract HandlerV2 is SettlerLogicV2, IEverclearV2, IHandlerV2 {
  ...
  function returnUnsupportedIntent(
    ...
    bytes memory _settlementMessageData = MessageLibV2.formatSettlementBatch(_settlementMessageBatch);
    (bytes32 _messageId,) =
