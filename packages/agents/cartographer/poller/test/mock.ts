  ...
  return {
    ...
    adapters: {
      subgraph: createStubInstance(SubgraphReader, {
        ...
        getReaderTypes: stub().returns(['goldsky']),
        // Per-reader checkpoint methods return [results, checkpoints]
        getOriginIntentsByNonceWithCheckpoints: stub().resolves([[], new Map()]),
        getDestinationIntentsByNonceWithCheckpoints: stub().resolves([[], new Map()]),
        getSettlementIntentsByNonceWithCheckpoints: stub().resolves([[], new Map()]),
        getOrdersByNonceWithCheckpoints: stub().resolves([[], new Map()]),
        getHubIntentsByNonceWithCheckpoints: stub().resolves([[[], [], []], {}, {}, {}]),
        getHubInvoicesByNonceWithCheckpoints: stub().resolves([[[], []], {}]),
        getDepositsEnqueuedByNonceWithCheckpoints: stub().resolves([[], {}]),
        getDepositsProcessedByNonceWithCheckpoints: stub().resolves([[], {}]),
        getDepositorEventsWithCheckpoints: stub().resolves([[], {}]),
        getSpokeMessagesWithCheckpoints: stub().resolves([[], {}]),
        getHubMessagesWithCheckpoints: stub().resolves([[], {}]),
      }),
