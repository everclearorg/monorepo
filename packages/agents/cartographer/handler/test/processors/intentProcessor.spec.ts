...
describe('intentProcessor', () => {
  ...
  describe('#processOriginIntent', () => {
    it('should parse webhook payload and save to database', async () => {
      const payload = {
        id: mkBytes32('0xaaa'),
        origin: '1337',
        destinations: ['1338'],
  ...
  describe('#processDestinationIntent', () => {
    ...
    it('should use destination from payload when no domain param', async () => {
      const payload = {
        id: mkBytes32('0xddd'),
        destination: '1338',
        amount: '9900',
      ...
      await processDestinationIntent(payload, context);
  ...
  describe('#processHubIntent', () => {
    it('should save with status column when only status present', async () => {
      const payload = {
        id: mkBytes32('0xeee'),
        status: 'ADDED',
        domain: '1339',
    ...
    it('should include added timestamp columns when addedTimestamp present', async () => {
      const payload = {
        id: mkBytes32('0xfff'),
        status: 'ADDED',
        domain: '1339',
    ...
    it('should include filled timestamp columns when filledTimestamp present', async () => {
      const payload = {
        id: mkBytes32('0x111'),
        status: 'FILLED',
        domain: '1339',
    ...
    it('should include settlement enqueued columns when present', async () => {
      const payload = {
        id: mkBytes32('0x222'),
        status: 'DISPATCHED',
        domain: '1339',
  ...
  describe('#processSettlementIntent', () => {
    ...
    it('should use domain from payload when no domain param', async () => {
      const payload = {
        id: mkBytes32('0x333'),
        amount: '9500',
        asset: mkAddress('0xaf88d065'),
      ...
      await processSettlementIntent(payload, context);
